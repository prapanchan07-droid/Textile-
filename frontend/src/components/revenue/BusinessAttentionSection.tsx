...
import { BusinessAttentionItem } from '../../types/revenueLoss';
import { Card } from '../ui/Card';
import { AlertCircle, AlertTriangle, Info } from 'lucide-react';

interface BusinessAttentionSectionProps {
  items: BusinessAttentionItem[];
}

export const BusinessAttentionSection: React.FC<BusinessAttentionSectionProps> = ({ items }) => {
  return (
    <Card className="space-y-4 p-6">
      <div className="border-b border-slate-100 pb-3">
        ...
        <p className="text-sm font-bold text-slate-900 mt-0.5">
          Priority financial and business exception alerts
        </p>
      </div>
